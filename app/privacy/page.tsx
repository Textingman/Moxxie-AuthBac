      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="prose prose-lg max-w-none">
          ...
          <p className="text-gray-600 mb-6">
            Auth Bac ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our SMS verification service and website.
          </p>
          ...
          <p className="text-gray-600 mb-6">
            To exercise these rights, please contact us at <a href="mailto:privacy@authbac.com" className="text-[#d364a4] hover:text-[#c24d93]">privacy@authbac.com</a>.
          </p>
          ...
          <div className="bg-gray-50 rounded-lg p-6 mb-8">
            <p className="text-gray-600 mb-2"><strong>Email:</strong> <a href="mailto:privacy@authbac.com" className="text-[#d364a4] hover:text-[#c24d93]">privacy@authbac.com</a></p>
