...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:block">
              <div className="ml-10 flex items-baseline space-x-4">
                ...
                <Link href="/about" className="text-[#6B7280] hover:text-[#2F6FA3] px-3 py-2 rounded-md text-sm font-medium">
                  About
                </Link>
      ...
      {/* Hero Section */}
      <section className="bg-gradient-to-b from-[#F5F7FA] to-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl font-extrabold text-[#1F2937] mb-4">
              Get Started with Auth Bac
            </h1>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12 border border-[#E5E7EB]">
          {submitStatus === 'success' ? (
            <div className="text-center py-12">
              ...
              <h2 className="text-3xl font-bold text-[#1F2937] mb-4">Thank You!</h2>
              <p className="text-lg text-[#6B7280] mb-8">
                We've received your request. Our team will contact you within 24 hours to get you started.
              </p>
              <Link
                href="/"
                className="inline-block px-6 py-3 bg-[#5E8F5E] text-white font-semibold rounded-lg hover:bg-[#4a7a4a] transition-colors"
              >
                Return to Home
              </Link>
            </div>
            ...
            <>
              <div className="mb-8">
                <h2 className="text-2xl font-bold text-[#1F2937] mb-2">Sign Up for Auth Bac</h2>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="block w-full pl-10 pr-3 py-3 border border-[#E5E7EB] rounded-lg focus:ring-2 focus:ring-[#1F4E79] focus:border-transparent text-[#1F2937]"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    className="block w-full px-3 py-3 border border-[#E5E7EB] rounded-lg focus:ring-2 focus:ring-[#1F4E79] focus:border-transparent text-[#1F2937]"
                    placeholder="How do you plan to use Auth Bac?"
                  />
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-[#1F4E79] text-white rounded-lg p-6">
                    <div className="flex items-start">
                      <input
                        type="checkbox"
                        id="sms-consent"
                        className="mt-1 h-4 w-4 text-[#5E8F5E] focus:ring-[#5E8F5E] border-gray-300 rounded flex-shrink-0"
                      />
                      <label htmlFor="sms-consent" className="ml-3 text-sm leading-relaxed">
                        By checking this box and submitting this form, you agree to receive account notification text messages from Auth Bac. I understand I may opt out of SMS communication by replying 'STOP'. Reply HELP or email support@authbac.com for help. Message and Data rates may apply. Message frequency varies. Carriers are not liable for delayed or undelivered messages. Opting in to SMS is optional and not required to submit this form. All messages will be handled by Auth Bac.
                      </label>
                    </div>
                  </div>
                  ...
                  <div className="bg-[#F5F7FA] border border-[#E5E7EB] rounded-lg p-6">
                    <div className="flex items-start">
                      <input
                        type="checkbox"
                        id="terms-consent"
                        className="mt-1 h-4 w-4 text-[#1F4E79] focus:ring-[#1F4E79] border-[#E5E7EB] rounded flex-shrink-0"
                      />
                      <label htmlFor="terms-consent" className="ml-3 text-sm leading-relaxed text-[#6B7280]">
                        I agree with the{' '}
                        <Link href="/terms" className="text-[#1F4E79] hover:text-[#2F6FA3] font-medium underline">
                          Terms & Conditions
                        </Link>{' '}
                        and{' '}
                        <Link href="/privacy" className="text-[#1F4E79] hover:text-[#2F6FA3] font-medium underline">
                          Privacy Policy
                        </Link>
                        .
                      </label>
                ...
                <button
                  ...
                  className={`w-full py-4 px-6 rounded-lg text-lg font-semibold transition-all ${
                    isSubmitting
                      ...
                      : 'bg-[#5E8F5E] hover:bg-[#4a7a4a] text-white shadow-lg hover:shadow-xl'
                  }`}
                >
                  {isSubmitting ? (
      ...
      {/* Footer */}
      <footer className="bg-[#1F4E79] text-white py-12 mt-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
